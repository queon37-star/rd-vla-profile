    ...
    def step(self):
        ...
        for group in self.param_groups:
            ...
            for p in params:
                ...
                g = p.grad
                if g is None:
                    continue  # Skip params without gradients
        ...
        for group in self.param_groups:
            ...
            for p in params:
                if p not in ns_inputs:
                    continue  # Skip params that weren't processed (no gradient)
                ...
                # calc update
                update = msign(ns_input, steps=ns_steps)
