...
def yam_bimanual_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # Don't need to do anything because dataset is already in the correct format
    # tf.print("yam_bimanual_transform called")
    # tf.print("trajectory keys:", trajectory.keys())
    # tf.print("observation keys:", trajectory["observation"].keys())
    # tf.print("action shape:", trajectory["action"].shape)
    # tf.print("state shape:", trajectory["observation"]["state"].shape)
    return trajectory
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    "calvin_abc": calvin_dataset_transform,
    ...
    ### real-world datasets
    "put_the_cube_into_the_bowl": yam_bimanual_transform,
    "toast_the_bread": yam_bimanual_transform,
    "wipe_the_dish": yam_bimanual_transform,
}
