#!/usr/bin/env python3
"""Validate formal origin-aware calibration artifacts and emit a JSON report."""
...
from scripts.origin_aware_calibration_lib import (  # noqa: E402
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--task-ids", nargs="+", type=int, default=list(CALIBRATION_TASK_IDS))
